...
class Prompt:
    ...
    def get_test_count(self) -> int:
        ...
        return int(self.metadata.get("test_count", 0))

    def is_production_tested(self) -> bool:
        """Check if prompt has been tested in production."""
        return bool(self.metadata.get("production_tested", False))
...
class PromptLibrary:
    ...
    def get_prompt(self, category: str, task_name: str | None = None) -> Prompt | None:
